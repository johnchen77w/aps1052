...
#INSERT CODE HERE USING CLOSE PRICES#
...
# short when spread < -X, else keep prior stance
dfP['Stance'] = np.where((dfP['42-252'] < -X), -1, dfP['Stance'])


#INSERT CODE HERE FOR SYSTEM RETURNS#
dfP['syst_rets'] = dfP['Stance'].shift(1) * dfP['pct_rets']
...
try:
    #INSERT CODE HERE FOR THE SHARPE PERFORMANCE METRIC#
